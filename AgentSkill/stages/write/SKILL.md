...
- 对外输出契约：`protocols/09-output-contracts.md`
- 交付与评审协议：`protocols/06-delivery-and-review.md`
- 真实数据优先验证（文档亦需证据）：`protocols/04-validation-real-data-first.md`

---

## library 索引（按触发条件查）

- 文档交付质量标准（结构/图示/验证/评分）：`library/documentation-quality-standard.md`
